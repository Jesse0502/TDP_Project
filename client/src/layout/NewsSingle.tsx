        ...
        <div className="ng-container top-20 relative grid grid-cols-12 gap-6">
          ...
          <div className="col-span-4 rounded-xl">
            <div className="w-full h-full">
              ...
              <div className={`p-4 rounded-xl shadow-xl  mb-4 relative ${
                !isStLoading
                  ? sentiment === 'POSITIVE'
                    ? 'bg-green-600'
                    : sentiment === 'NEGATIVE'
                    ? 'bg-red-600'
                    : 'bg-yellow-500' // Fallback for neutral sentiment
                  : 'bg-gray-600'
              }`}>
                ...
                <div className="absolute top-1/2 right-5 -translate-y-1/2">
                  ...
                  {!isStLoading &&
                    (sentiment === 'POSITIVE' ? (
                      ...
                      // New icon for neutral sentiment
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
                        viewBox="0 0 24 24"
                      ...
                      <path stroke-linecap="round" stroke-linejoin="round" d="M15.182 16.318A4.486 4.486 0 0 0 12.016 15a4.486 4.486 0 0 0-3.198 1.318M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0ZM9.75 9.75c0 .414-.168.75-.375.75S9 10.164 9 9.75 9.168 9 9.375 9s.375.336.375.75Zm-.375 0h.008v.015h-.008V9.75Zm5.625 0c0 .414-.168.75-.375.75s-.375-.336-.375-.75.168-.75.375-.75.375.336.375.75Zm-.375 0h.008v.015h-.008V9.75Z" />
                        ...
                        <path
                          strokeLinecap="round"
                          strokeLinejoin="round"
                          d="M15 15H9m6-5a.75.75 0 1 0 0-1.5.75.75 0 0 0 0 1.5Zm-6-.75a.75.75 0 1 1 0 1.5.75.75 0 0 1 0-1.5ZM21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z"
                        />
                      </svg>
                    ))}
                </div>
